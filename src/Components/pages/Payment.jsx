...
import amazonlogo from "../pages/assets/payment-logo.webp"
...
const Payment = () => {
  ...
  const totalPrice=Product.reduce((acc,curr)=>acc+parseInt(curr.total),0)
      //  console.log(Product);
      //  const cartproducts=Product.map((product)=>{
      //   return(
      //     product.
      //   )
